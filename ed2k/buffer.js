...
Buffer.prototype.getUInt8 = function () {
    let r = this.readUInt8(this._pointer, conf.noAssert);
    this._pointer++
    return r
}
    ...
    for (let i = 0; i < tagsCount; i++) {
        ...
        switch (t[0]) {
            ...
            case TYPE_UINT32:
                ...
                break
            default:
                log.error('Buffer.tagsLength: Unhandled tag type: 0x' + t[0].toString(16))
        }
    }
    return len
}
...
Buffer.prototype.putTag = function (tag) {
    ...
    switch (tag[0]) { // data
        ...
        case TYPE_UINT32:
            ...
            break
        default:
            log.error('Buffer.putTag: Unhandled tag type: 0x' + tag[0].toString(16))
    }
}
