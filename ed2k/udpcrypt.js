...
const MAGICVALUE_UDP_SERVERCLIENT = 0xA5;
const MAGICVALUE_UDP_CLIENTSERVER = 0x6B;
const MAGICVALUE_UDP_SYNC_CLIENT = 0x395F2EC1;
const MAGICVALUE_UDP_SYNC_SERVER = 0x13EF24D5;
const keyBufferSize = 0xffffff;
const sendKeys = new Buffer(keyBufferSize);
const recvKeys = new Buffer(keyBufferSize)
